...
async function createTables() {
    ...
    await client.query(`
      CREATE TABLE IF NOT EXISTS broku_co_downstream_input_raw (
    ...
    await client.query(`
      CREATE TABLE IF NOT EXISTS broku_co_downstream_input_formatted (
        uuid UUID NOT NULL DEFAULT gen_random_uuid(),
    ...
    await client.query(`
      CREATE TABLE IF NOT EXISTS broku_co_downstream_output_formatted (
        uuid UUID NOT NULL DEFAULT gen_random_uuid(),
    ...
    // downstream_input_raw
    await client.query(`
      CREATE TABLE IF NOT EXISTS broku_co_downstream_output_raw (
        uuid UUID NOT NULL DEFAULT gen_random_uuid(),
